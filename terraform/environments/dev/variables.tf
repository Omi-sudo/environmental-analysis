variable "project_id" {
  ...
  default     = "dec-cam-d-warehouse-b3b3"
...
variable "composer_sa" {
  type        = string
  default     = "dec-cam-d-composer-sa@dec-cam-d-warehouse-b3b3.iam.gserviceaccount.com"
  description = "Composer Service Account"
}
...
variable "artifact_repo" {
  type        = string
  default     = "dec-cam-api-d-ar-us-east4-ingestion-b3b3"

# Google Solutions - Environmental Analysis Solution
...
* Run the following to set up critical context and environment variables:
  ...
  - Set the current context to `gke_environmental-analysis_us-central1_default_cluster`. The default cluster name is `default_cluster`.
